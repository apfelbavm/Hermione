...
const SIDEBAR_LINKS: SidebarLinkDef[] = [
  ...
  },
  {
    ...
    icon: <CredentialVaultIcon />,
  },
  { href: "/logs", label: i18n.components.sidebar.logs, icon: <LogsIcon /> },
  {
    href: "/emulate",
  ...
  return (
    <nav className="app-sidebar">
      <button
        ...
        title={i18n.components.sidebar.collapse_title}
      >
        <span className="app-sidebar-link-icon">
          <CollapseIcon />
        </span>
        <span className="app-sidebar-link-label">
          {i18n.components.sidebar.collapse}
        </span>
      </button>
