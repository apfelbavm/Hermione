...
4. Batch multi-step edits into a single graph.apply_changes call using tempId to reference nodes you're creating in the same batch, instead of many separate calls.
