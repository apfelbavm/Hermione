 ...
 * restored (clamped to the CURRENT viewport, in case the window shrank since) on setup.
 ...
 * index.html for the #left-sidebar-resizer/#right-sidebar-resizer/#log-resizer elements this
 * binds to. */
