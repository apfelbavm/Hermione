...
registerNode({
  ...
  pins: [
    ...
    { id: "rootTag", label: i18n.nodes.csv.toJson.pin_root_tag, type: "string", direction: "input", defaultValue: "rows" },
    { id: "rowTag", label: i18n.nodes.csv.toJson.pin_row_tag, type: "string", direction: "input", defaultValue: "row" },
...
registerNode({
  ...
  pins: [
    ...
    { id: "csv", label: i18n.nodes.__shared.pin_csv, type: "string", direction: "input", defaultValue: "" },
    { id: "delimiter", label: i18n.nodes.__shared.pin_delimiter, type: "string", direction: "input", defaultValue: "," },
    { id: "rootTag", label: i18n.nodes.csv.toXml.pin_root_tag, type: "string", direction: "input", defaultValue: "rows" },
    { id: "rowTag", label: i18n.nodes.csv.toXml.pin_row_tag, type: "string", direction: "input", defaultValue: "row" },
    { id: "exec-out", label: "", type: "exec", direction: "output" },
